function triggerCountdown(countdownElem, days, hours, minutes, seconds) {
    ...
    const countdownInterval = setInterval(function () {
        ...
        if (countdownElement) {
            ...
            if (daysElem) daysElem.innerHTML = displayDays;
            if (hoursElem) hoursElem.innerHTML = displayHours;
            if (minutesElem) minutesElem.innerHTML = displayMinutes;
            if (secondsElem) secondsElem.innerHTML = displaySeconds;
        }
