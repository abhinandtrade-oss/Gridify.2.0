            ...
            filtered.forEach(s => {
                tbody.append(`
                    <tr>
                        ...
                        <td class="text-end">
                            <button class="action-btn" onclick="window.editSub('${s.id}')"><i class="fas fa-edit"></i></button>
                            <button class="action-btn btn-delete" onclick="window.deleteSub('${s.id}')"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                `);
            });
